namespace University.Migrations
{
    ...
    public partial class ComplexDataModel : DbMigration
    {
        public override void Up()
        {
            ...
            ///Если вы еще не добавили какие-либо курсы в пользовательский интерфейс,
            ///вам больше не потребуется "Temp" или значение по умолчанию в столбце "Course.DepartmentID"
